...
void FourierRebinning::do_log_file() { // CL Saving time details and write them to log file
  char file[200];
...
void FourierRebinning::do_display_count(PETCount_rebinned& count) { // Display rebinning statistics
