...
Succeeded
BinNormalisation::set_up(const shared_ptr<const ProjDataInfo>& proj_data_info_sptr) {
...
void
BinNormalisation::apply(ProjData& proj_data, const double start_time, const double end_time,
