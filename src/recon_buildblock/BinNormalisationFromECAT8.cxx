...
Succeeded
BinNormalisationFromECAT8::set_up(const shared_ptr<const ProjDataInfo>& proj_data_info_ptr_v) {
...
#if 1
float
BinNormalisationFromECAT8::get_bin_efficiency(const Bin& bin, const double start_time, const double end_time) const {
