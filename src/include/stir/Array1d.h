...
const elemT& Array<1, elemT>::operator[](int i) const { return base_type::operator[](i); };

elemT& Array<1, elemT>::operator[](int i) { return base_type::operator[](i); };

const elemT& Array<1, elemT>::operator[](const BasicCoordinate<1, int>& c) const { return (*this)[c[1]]; };

elemT& Array<1, elemT>::operator[](const BasicCoordinate<1, int>& c) { return (*this)[c[1]]; };
