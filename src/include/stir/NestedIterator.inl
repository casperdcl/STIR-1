...
template <class topleveliterT, class GetRestRangeFunctionT>
typename NestedIterator<topleveliterT, GetRestRangeFunctionT>::reference NestedIterator<topleveliterT, GetRestRangeFunctionT>::
operator*() const {
  return *this->_current_rest_iter;
}

template <class topleveliterT, class GetRestRangeFunctionT>
typename NestedIterator<topleveliterT, GetRestRangeFunctionT>::pointer NestedIterator<topleveliterT, GetRestRangeFunctionT>::
operator->() const {
